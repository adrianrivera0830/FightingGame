...
public class PlayerWallRunLeft : PlayerBaseState
{
    public PlayerWallRunLeft(PlayerContext context) : base(context)
    {
    }
    
    public override void OnEnter()
    {
        _animationRequester.RequestAnimation(_animations.wallrunLeft);
        Vector3 wallDirection = Vector3.left;
